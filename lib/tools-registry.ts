...
export const TOOLS: Tool[] = [
  ...
  { slug: 'base64',             category: 'encoding', i18nKey: 'base64',             enabled: false, icon: 'FileText'     },
  { slug: 'url-encode',         category: 'encoding', i18nKey: 'url-encode',         enabled: false, icon: 'Link'         },
  { slug: 'html-entities',      category: 'encoding', i18nKey: 'html-entities',      enabled: false, icon: 'Code2'        },
  { slug: 'hash-generator',     category: 'crypto',   i18nKey: 'hash-generator',     enabled: false, icon: 'Hash'         },
  { slug: 'uuid-generator',     category: 'crypto',   i18nKey: 'uuid-generator',     enabled: false, icon: 'Fingerprint'  },
  ...
  { slug: 'timestamp',          category: 'datetime', i18nKey: 'timestamp',          enabled: false, icon: 'Clock'        },
  ...
  { slug: 'word-counter',       category: 'text',     i18nKey: 'word-counter',       enabled: false, icon: 'AlignJustify' },
